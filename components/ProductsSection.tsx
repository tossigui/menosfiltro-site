  ...
  const products = [
    {
      ...
      duration: "5 dias",
      target:
        "Para mulheres entre 18-30 anos com inchaço abdominal, retenção de líquidos e falta de tempo para dietas complicadas.",
      features: [
    ...
    },
    {
      ...
      duration: "7 dias",
      target:
        "Para mulheres de 16-35 anos com pele oleosa, acneica ou com cravos que buscam soluções naturais e acessíveis.",
      features: [
    ...
    },
    {
      ...
      duration: "7 dias",
      target:
        "Para mulheres entre 18-40+ anos que se sentem com o corpo flácido e desejam melhorar glúteos, barriga e postura.",
      features: [
